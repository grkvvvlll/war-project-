namespace Core.Factories
{
    public static class UnitFactory
    {
        ...
        // HEALER 
        public const int HealerAttack = 5;
        public const int HealerDefence = 2;
        public const int HealerHP = 10;
        public const int HealerCost = 35;
        public const int HealerRange = 3;
        public const int HealerPower = 8;

        // WIZARD 
        public const int WizardAttack = 6;
        public const int WizardDefence = 1;
