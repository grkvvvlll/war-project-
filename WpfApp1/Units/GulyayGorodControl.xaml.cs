...
{
    public partial class GulyayGorodControl : UserControl
    {
        public static readonly DependencyProperty IsArmy1Property =
            DependencyProperty.Register(nameof(IsArmy1), typeof(bool), typeof(GulyayGorodControl),
        ...
        {
            if (d is GulyayGorodControl ctrl) ctrl.UpdateColor();
        }
