...
{
    public partial class HealerUnitControl : UserControl
    {
        public static readonly DependencyProperty IsArmy1Property =
            DependencyProperty.Register(nameof(IsArmy1), typeof(bool), typeof(HealerUnitControl),
        ...
        {
            if (d is HealerUnitControl ctrl) ctrl.UpdateColor();
        }
        ...
        public void PlayHeal() => ((Storyboard)Resources["HealAnim"]).Begin(Root);
