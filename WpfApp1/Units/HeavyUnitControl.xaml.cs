...
{
    public partial class HeavyUnitControl : UserControl
    {
        public static readonly DependencyProperty IsArmy1Property =
            DependencyProperty.Register(nameof(IsArmy1), typeof(bool), typeof(HeavyUnitControl),
        ...
        {
            if (d is HeavyUnitControl ctrl) ctrl.UpdateColor();
        }
